...
<div class="row g-3">
    ...
    <div class="col-12 col-md-8">
        <label for="business_name" class="form-label fw-semibold">Razon social <span class="text-danger" aria-hidden="true">*</span></label>
        <input id="business_name" type="text" name="business_name" class="form-control @error('business_name') is-invalid @enderror"
            value="{{ old('business_name', $company?->business_name) }}" maxlength="255" required aria-required="true">
        @error('business_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
    </div>

    <div class="col-12 col-md-4">
        <label for="tax_id" class="form-label fw-semibold">CIF / NIF</label>
        <input id="tax_id" type="text" name="tax_id" class="form-control @error('tax_id') is-invalid @enderror"
            value="{{ old('tax_id', $company?->tax_id) }}" maxlength="20">
        @error('tax_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
    </div>

    <div class="col-12 col-md-8">
        <label for="activity" class="form-label">Actividad / Sector</label>
        <input id="activity" type="text" name="activity" class="form-control @error('activity') is-invalid @enderror"
    ...
    <div class="col-12 col-md-4">
        <label for="main_phone" class="form-label">Telefono principal</label>
        <input id="main_phone" type="text" name="main_phone" class="form-control @error('main_phone') is-invalid @enderror"
    ...
    <div class="col-12 col-md-4">
        ...
        <input id="secondary_phone" type="text" name="secondary_phone" class="form-control @error('secondary_phone') is-invalid @enderror"
    ...
    <div class="col-12 col-md-6">
        <label for="social_address" class="form-label">Direccion</label>
        <input id="social_address" type="text" name="social_address" class="form-control @error('social_address') is-invalid @enderror"
    ...
    <div class="col-12 col-md-2">
        <label for="social_postal_code" class="form-label">Cod. postal</label>
        <input id="social_postal_code" type="text" name="social_postal_code" class="form-control @error('social_postal_code') is-invalid @enderror"
    ...
    <div class="col-12 col-md-2">
        <label for="social_municipality" class="form-label">Municipio</label>
        <input id="social_municipality" type="text" name="social_municipality" class="form-control @error('social_municipality') is-invalid @enderror"
    ...
    <div class="col-12 col-md-2">
        <label for="social_province" class="form-label">Provincia</label>
        <input id="social_province" type="text" name="social_province" class="form-control @error('social_province') is-invalid @enderror"
    ...
    <div class="col-12 col-md-3">
        <label for="representative_nif" class="form-label">NIF representante</label>
        <input id="representative_nif" type="text" name="representative_nif" class="form-control @error('representative_nif') is-invalid @enderror"
    ...
    <div class="col-12 col-md-3">
        <label for="representative_name" class="form-label">Nombre</label>
        <input id="representative_name" type="text" name="representative_name" class="form-control @error('representative_name') is-invalid @enderror"
    ...
    <div class="col-12 col-md-3">
        <label for="representative_last_name_1" class="form-label">Primer apellido</label>
        <input id="representative_last_name_1" type="text" name="representative_last_name_1" class="form-control @error('representative_last_name_1') is-invalid @enderror"
    ...
    <div class="col-12 col-md-3">
        <label for="representative_last_name_2" class="form-label">Segundo apellido</label>
        <input id="representative_last_name_2" type="text" name="representative_last_name_2" class="form-control @error('representative_last_name_2') is-invalid @enderror"
